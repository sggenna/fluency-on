...
const FinalCTA: React.FC = () => {
  ...
  return (
    <section
      id="final-cta"
      className="relative py-20 md:py-32 bg-dark-green overflow-hidden"
    >
      {/* Pattern Overlay */}
        ...
        <ScrollReveal animation="fade-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center">
            ...
            <button
              ...
              className="bg-transparent border-2 border-light-gray hover:bg-light-gray text-light-gray hover:text-dark-green font-bold py-4 px-8 md:py-5 md:px-12 rounded-lg text-lg md:text-xl transition-all duration-300 transform hover:scale-105"
            >
