...
const STORAGE_KEYS = {
  ...
  name: 'student_settings_name',
  phone: 'student_settings_phone',
};
...
export function Settings() {
  ...
  useEffect(() => {
    setName(localStorage.getItem(STORAGE_KEYS.name) ?? 'Ana Maria');
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-[#253439] mb-2">Configurações</h1>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  value="ana.maria@email.com"
                  readOnly
                  className="w-full pl-10 pr-4 py-3 border border-[#b29e84]/20 rounded-lg bg-[#f6f4f1] text-[#7c898b]"
                />
                <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#7c898b]">Alterar na ativação</span>
              </div>
            </div>
          </div>
        </div>
