      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {resources.map((resource) => (
            <div
              key={resource.id}
              className="bg-light-gray rounded-2xl p-8 shadow-xl relative overflow-hidden"
            >
              {/* FREE Badge */}
              <div className="absolute top-4 right-4 bg-vivid-red text-white px-4 py-2 rounded-full font-bold text-sm md:text-base shadow-lg">
                GRÁTIS
              </div>
              ...
              <div className="mt-8">
                ...
                <p className="text-dark-green/80 mb-6 text-lg">
