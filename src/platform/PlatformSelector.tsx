...
export default function PlatformSelector() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f6f4f1] via-[#f6f4f1] to-[#b29e84]/20 flex items-center justify-center p-8">
      <div className="max-w-4xl w-full">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="w-20 h-20 bg-gradient-to-br from-[#253439] to-[#7c898b] rounded-2xl flex items-center justify-center mx-auto mb-6">
            <GraduationCap className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-4xl font-bold text-[#253439] mb-3">FluencyOn</h1>
          <p className="text-xl text-[#7c898b]">Plataforma Educacional</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <button
            ...
            className="group bg-white rounded-2xl p-8 border-2 border-[#b29e84]/20 hover:border-[#fbb80f] transition-all hover:shadow-xl text-left"
          >
          ...
          <button
            ...
            className="group bg-white rounded-2xl p-8 border-2 border-[#b29e84]/20 hover:border-[#253439] transition-all hover:shadow-xl text-left"
          >
        ...
        <div className="mt-12 text-center">
          <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-[#b29e84]/20">
